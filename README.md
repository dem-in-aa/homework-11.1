# Домашнее задание к занятию 11.1. «Базы данных, их типы» Андрей Дёмин
...
3) Ввод необходимой суммы
4) Проверка наличия необходимой суммы на счёте
5) Обработка платежа (блокировка суммы платежа и перевод на другой счёт)
6) Списание денег со счёта 
...
2) Обработка платежа по ранее сохраненному шаблону
